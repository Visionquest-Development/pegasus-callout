...
*/
	...
	* Proper way to enqueue JS 
	...
	function pegasus_callout_plugin_admin_scripts() {
		
		wp_enqueue_style( 'pegasus-callout-admin-css', get_stylesheet_uri() );
		...
		<?php
		wp_add_inline_style( 'pegasus-callout-admin-css', ob_get_clean() );
	}
	add_action( 'admin_enqueue_scripts', 'pegasus_callout_plugin_admin_scripts' ); 
